...
class Level:
    ...
    #working out if the player is in the air or not - call it before vertical movement collision function in update
    ...
    #call this after vertical collision
    ...
    def run(self):
        ...
        #dust particles
        self.dust_sprite.update(self.level_scroll)
